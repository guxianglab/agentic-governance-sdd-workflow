...
tools: Agent(sdd-architecture-reviewer, sdd-code-reviewer, sdd-delivery, sdd-draft, sdd-implementer, sdd-requirement, sdd-scheduler, sdd-security-reviewer), Read, Glob, Grep, Bash, Edit, Write
model: inherit
